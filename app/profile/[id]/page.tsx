            ...
            <MainLayout>
                <div className="pt-[90px] ml-[90px] 2xl:pl-[185px] lg:pl-[160px] lg:pr-0 w-[calc(100%-90px)] pr-3 max-w-[1800px] 2xl:mx-auto">
                    <div className="flex w-[calc(100vw-230px)]">
                        ...
                        <ClientOnly>
                            {currentProfile ? (
                                <img className="max-w-[120px] min-w-[120px] rounded-full" alt="aaaa" src={useCreateBucketUrl(currentProfile?.image)} />
                            ) : (
                        ...
                        <div className="ml-5 w-full">
                            ...
                            {contextUser?.user?.id == params?.id ? (
                                <button 
                                    ...
                                    className="flex item-center rounded-md py-1.5 px-3.5 mt-3 text-[15px] font-semibold border hover:opacity-75"
                                >
                                    <BsPencil className="mt-0.5 mr-1" size="18"/>
                                    <span>Edit profile</span>
                                </button>
                            ) : (
                                <button className="flex item-center rounded-md py-1.5 px-8 mt-3 text-[15px] text-white font-semibold bg-[#0f0d2c] hover:opacity-75"
                                onClick={() => {
