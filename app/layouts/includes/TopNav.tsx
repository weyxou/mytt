...
export default function TopNav() {    
    ...
    return (
        <>
            <div id="TopNav" className='fixed bg-[#0f0d2c] z-30 flex items-center w-full border-b h-[60px]'>
                <div className={`flex items-center justify-between gap-6 w-full px-4 mx-auto ${pathname === '/' ? 'max-w-[1150px]' : ''}`}>

                    <Link href="/">
                        {/* <img className="min-w-[115px] w-[115px]" src="/images/tiktok-logo.png"/>npm */}
                    </Link>
                    ...
                    <div className="flex items-center gap-3 ">
                        <button 
                            onClick={() => goTo()}
                            className="flex items-center border rounded-sm py-[6px]  hover:opacity-75 pl-1.5"
                        >
                            <AiOutlinePlus color="white" size="22"/>
                            <span className="px-2 text-white font-medium text-[15px]">Upload</span>
                        </button>
                        ...
                        {!userContext?.user?.id ? (
                            <div className="flex items-center">
                                <button 
                                    ...
                                    className="flex items-center bg-[#0f0d2c] text-white border rounded-md px-3 py-[6px]"
                                >
